...
namespace AlicizaX.Resource.Runtime
{
    ...
    internal readonly struct ResourceLoadLifetime
    {
        internal readonly ResourceBindingService Bindings;
        internal readonly ResourceOwner Owner;
        internal readonly int OwnerId;
        internal readonly uint OwnerGeneration;
        internal readonly int BindingIndex;
        internal readonly uint Version;

        internal ResourceLoadLifetime(ResourceBindingService bindings, ResourceOwner owner, int bindingIndex = -1, uint version = 0)
        {
            Bindings = bindings;
            Owner = owner;
        ...
        internal bool IsCurrent => Bindings == null || Bindings.IsLoadCurrent(this);
    }
}
