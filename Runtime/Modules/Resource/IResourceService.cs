...
namespace AlicizaX.Resource.Runtime
{
    ...
    public interface IResourceService : IService
    {
        ...
        int IdleAssetCapacity { get; set; }
        T LoadAsset<T>(ResourceOwner owner, string location, string packageName = "") where T : UnityEngine.Object;
        UniTask<T> LoadAssetAsync<T>(ResourceOwner owner, string location, CancellationToken cancellationToken = default, string packageName = "") where T : UnityEngine.Object;
        /// <summary>
        /// 获取当前资源适用的游戏版本号。
        /// </summary>
