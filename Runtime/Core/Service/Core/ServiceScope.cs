...
namespace AlicizaX
{
    public sealed class ServiceScope : IDisposable
    {
        ...
        private readonly Dictionary<RuntimeTypeHandle, IService> _servicesByContract = new Dictionary<RuntimeTypeHandle, IService>(ServiceContractUtility.HandleComparer);
